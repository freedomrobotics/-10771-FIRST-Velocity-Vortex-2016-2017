...
LOCAL_SRC_FILES = ../jni_src/lib/$(TARGET_ARCH_ABI)/libVuforia.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../jni_src/include
...
LOCAL_SRC_FILES := SampleAppRenderer.cpp SampleUtils.cpp Texture.cpp NativeCameraCode.cpp ImageTargets2.cpp
