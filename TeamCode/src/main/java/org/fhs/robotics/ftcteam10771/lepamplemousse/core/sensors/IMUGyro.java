...
public class IMUGyro {
    ...
    public IMUGyro(BNO055IMU imu, boolean calibrating, boolean initialize){
        this.imu = imu;
        parameters = new BNO055IMU.Parameters();
        parameters.angleUnit = BNO055IMU.AngleUnit.RADIANS;
        parameters.accelUnit = BNO055IMU.AccelUnit.METERS_PERSEC_PERSEC;
        parameters.mode = BNO055IMU.SensorMode.GYRONLY;
        //TODO NOTE: ONLY GYRO RUNS NOW
     ...
     */
    public float convert(IMU.Axis axis, float value){
     ...
     * @return the converted angle
     */
    public float convertAngletoSemiPossibleRange(IMU.Axis axis, float value){
        float parameter = angleParam();
